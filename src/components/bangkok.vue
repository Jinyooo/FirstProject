    ...
    <v-app> 
        ...
        <v-main>
            ...
            >
                ...
                <!-- 문의하기 버튼 -->
                <v-dialog v-model="inquire" max-width="100%">
                    <template v-slot:activator="{ on, attrs }">
...
export default {
    ...
    data: () => ({
        ...
        photos : [
            'https://cdn.pixabay.com/photo/2015/11/03/13/30/bangkok-1020850__480.jpg',
            'https://cdn.pixabay.com/photo/2017/09/09/15/47/bangkok-2732437__480.jpg',
            'https://cdn.pixabay.com/photo/2015/10/18/04/33/thailand-993856__480.jpg',
            'https://cdn.pixabay.com/photo/2017/04/22/14/31/bangkok-2251490__480.jpg'
        ],
        onList : false,
        type : 0,
        search : false,
